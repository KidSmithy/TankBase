...
// void opcontrol() {
//   lf.move_relative(574, 150);
//   lm.move_relative(574, 150);
//   lb.move_relative(574, 150);
//   rf.move_relative(574, -150);
//   rm.move_relative(574, -150);
//   rb.move_relative(574, -150);
...
//   }
//   pros::delay(200);
//   lf.move_relative(-1300, -100);
//   lm.move_relative(-1300, -100);
//   lb.move_relative(-1300, -100);
//   rf.move_relative(-1300, 100);
//   rm.move_relative(-1300, 100);
//   rb.move_relative(-1300, 100);
//   pros::delay(2000);
...
//   rb.move(-20);
//   pros::delay(1000);
//   lf.move_relative(820.2, 500);
//   lm.move_relative(820.2, 500);
//   lb.move_relative(820.2, 500);
//   rf.move_relative(820.2, -500);
//   rm.move_relative(820.2, -500);
//   rb.move_relative(820.2, -500);
//   // pros::delay(2000);
//   // lf.move_relative(900, 80);
//   // lm.move_relative(900, 80);
//   // lb.move_relative(900, 80);
//   // rf.move_relative(900, -80);
//   // rm.move_relative(900, -80);
//   // rb.move_relative(900, -80);
//   // pros::delay(2000);
//   // lf.move_relative(-1312, 100);
//   // lm.move_relative(-1312, 100);
//   // lb.move_relative(-1312, 100);
//   // rf.move_relative(-1312, -100);
//   // rm.move_relative(-1312, -100);
//   // rb.move_relative(-1312, -100);
//   // pros::delay(2000);
//   // turn_to_angle(359.9);
//   // while (is_turning) {
//   //   update_turning(1.2, 0, 0.7);
//   //   pros::delay(20); // Control update rate
//   // }
