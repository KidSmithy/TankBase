...
void opcontrol() {
  ...
  pros::delay(200);
  lf.move_relative(2296, 600);
  lm.move_relative(2296, 600);
  lb.move_relative(2296, 600);
  rf.move_relative(2296, -600);
  rm.move_relative(2296, -600);
  rb.move_relative(2296, -600);
